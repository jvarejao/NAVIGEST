...
using NAVIGEST.macOS.Services.Icons;             // IIconProvider

namespace NAVIGEST.macOS.Services.Icons
{
    // Uso em XAML:
    // xmlns:icons="clr-namespace:NAVIGEST.macOS.Services.Icons"
    ...
    public sealed class Icon : IMarkupExtension<ImageSource>
    {
        ...
        public ImageSource ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            return new FontImageSource
            {
                Glyph = "\uf128", // info
                Size = Size,
                FontFamily = "resm:NAVIGEST.macOS.Resources.Fonts.fa7_solid.otf#FA7Solid"
            };
#else
            return new FontImageSource
            {
