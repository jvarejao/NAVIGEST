...
using AppLoginMaui.Services.Icons;             // IIconProvider

namespace AppLoginMaui.Services.Icons
{
    // Uso em XAML:
    // xmlns:icons="clr-namespace:AppLoginMaui.Services.Icons"
    ...
    public sealed class Icon : IMarkupExtension<ImageSource>
    {
        ...
        public ImageSource ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            return new FontImageSource
            {
                Glyph = "\uf128", // info
                Size = Size,
                FontFamily = "resm:AppLoginMaui.Resources.Fonts.fa7_solid.otf#FA7Solid"
            };
#else
            return new FontImageSource
            {
