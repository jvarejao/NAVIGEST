...
using AppLoginMaui.PageModels; // ou ViewModels, conforme está o teu VM
        ...
        private async void OnPageLoaded(object sender, EventArgs e)
        {
            ...
            try
            {
                if (BindingContext is ServicePageModel m)
                {
                    ...
                    if (m.Orders.Count == 0)
                        await AppLoginMaui.AppShell.DisplayToastAsync("0 serviços carregados.");
                }
                else
                {
            ...
            catch (Exception ex)
            {
                ...
                await AppLoginMaui.AppShell.DisplayToastAsync("Falha ao carregar serviços.");
            }
        }
