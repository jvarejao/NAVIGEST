...
using AppLoginMaui.Services.Icons; // <-- IIconProvider (namespace)
using AppLoginMaui.Pages;          // <-- ADICIONADO: HoursEntryPage
using AppLoginMaui.ViewModels;     // <-- ADICIONADO: HoursEntryViewModel
...
namespace AppLoginMaui
{
    public static class MauiProgram
    {
        public static MauiApp CreateMauiApp()
        {
            ...
            builder.Services.AddSingleton<AppLoginMaui.Services.Auth.IBiometricAuthService, AppLoginMaui.Services.Auth.BiometricAuthService>();
            builder.Services.AddTransient<AppLoginMaui.PageModels.LoginPageModel>();
