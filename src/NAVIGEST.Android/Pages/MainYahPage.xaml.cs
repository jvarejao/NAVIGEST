    ...
    public partial class MainYahPage : ContentPage
    {
        ...
        public MainYahPage()
        {
            try
            {
                ...
                Debug.WriteLine("[Android/MainYahPage] BindingContext initialized and session refreshed.");
            }
        ...
        protected override void OnAppearing()
        {
            ...
            try
            {
                ...
                {
                    vm.RefreshUserContext();
                    Debug.WriteLine($"[Android/MainYahPage] OnAppearing refreshed session for company '{vm.CompanyName}'.");
                }
            }
            catch (Exception ex) { TratarErro(ex); }
        }
