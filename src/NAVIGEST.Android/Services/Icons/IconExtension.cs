...
using NAVIGEST.Android.Services.Icons;             // IIconProvider

namespace NAVIGEST.Android.Services.Icons
{
    // Uso em XAML:
    // xmlns:icons="clr-namespace:NAVIGEST.Android.Services.Icons"
    ...
    public sealed class Icon : IMarkupExtension<ImageSource>
    {
        ...
        public ImageSource ProvideValue(IServiceProvider serviceProvider)
        {
            ...
            return new FontImageSource
            {
                Glyph = "\uf128", // info
                Size = Size,
                FontFamily = "resm:NAVIGEST.Android.Resources.Fonts.fa7_solid.otf#FA7Solid"
            };
#else
            return new FontImageSource
            {
